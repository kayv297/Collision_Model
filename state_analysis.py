...
def calc_fidelity(ideal_state: np.ndarray, actual_state: np.ndarray) -> float:
    '''
    ...
    '''
    # fidelity = np.abs(np.vdot(ideal_state, np.abs(actual_state)))**2 # ignore the local phase
